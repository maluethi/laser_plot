...
if data:
    ...
    laser_file2 = base_dir + "laser-data-23-cross-calib.npy"
...
print("saved to dist-{}.npy".format(dx))
np.savez('output/cross_dist/dist-{}.npz'.format(dx), d=dist_d, dtrue=dtrue, dreco=np.array(dreco))
